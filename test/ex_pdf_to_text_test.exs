defmodule ExPdfToTextTest do
  ...
  describe "from_content" do
    test "parses content correctly" do
      ...
      assert {:ok, content} = ExPdfToText.from_content(content)
      assert content =~ "Hello World"
    end
  end
